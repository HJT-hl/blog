import {h,defineComponent, readonly, ref, reactive, computed, onMounted} from "vue"
...
export default defineComponent({
    ...
    setup(props,{slots}){
        ...
        const login = reactive({user : "",photo : ""})
        ...
        onMounted(()=>{
            postIfLogin().then(res=>{
                if (res.data.userInfo) {
                    ifLogin.value = true;
                    login.user = res.data.userInfo.user;
                    login.photo = res.data.userInfo.photo;
                }else{
                    ifLogin.value = false;
                }
            });
